...
sudo jool -4at --mark 1 192.0.2.1 10-15
sudo jool -4at --mark 2 192.0.2.2 10-15
...
sudo jool -4ai --mark 2 192.0.2.1 10-15

sudo jool -bat 2001:db8::1#2000 192.0.2.1#10
sudo jool -bat 2001:db8::1#2001 192.0.2.1#13
sudo jool -bat 2001:db8::1#2002 192.0.2.1#15
